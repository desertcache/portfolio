...
window.PORTFOLIO_DATA_V4 = {
  identity: {
    ...
    org: "Currently: DoorDash · Merchant Experience Ops",
  ...
  migration: {
    ...
    build: "Designed the operating model end-to-end: Salesforce Omni-Channel queues, 3-day cadence, 200–300 touches/day, training docs, escalation paths. Built the Square dashboard in Sigma — full BAT funnel, V1→V2 progress, GMV at every stage, in one view.",
    result: [
  ...
  projects: [
    {
      id: "wfm",
      year: "2026",
      title: "WFM 2.0 — Workforce Operations Platform",
      one: "Real-time platform replacing legacy SaaS for 139 queues across 6 BPO vendors.",
      what: "Production WFM platform consolidating 20+ data sources into one operating surface. 18 dashboard pages, micro-frontend, published shared component library (v1.7.10), live across 14 cells. 7 production deploys in April 2026 alone (v2.197 → v2.307).",
      ...
      validation: "“This is so cool — going to save me.” — WFM stakeholder demo, Feb 20, 2026 (Logan Rothenberger, Paige Thomas, Kohl Sharples, William Zeng, et al.)",
    },
    {
      id: "ime",
      year: "2025–26",
      title: "IME — Intelligent Mapping Engine",
      one: "Replaced 1–7 day spreadsheet workflows with a real-time product. 557K records flowing live.",
      what: "Dual-stack: React frontend, Fastify BFF, Snowflake. Solved the bugs the team would have lost weeks to — typed callback that silently terminated the warehouse connection; auth race opening multiple browser tabs; silent ~1K row cap on the AI query service. Absorbed into WFM 2.0 in March; live across all 14 cells.",
      stack: ["React", "Fastify", "snowflake-sdk", "Prometheus", "GraphQL"],
      stats: [
        { k: "Records flowing", v: "557,337" },
        { k: "MXPs covered", v: "326" },
        { k: "Pages", v: "6" },
        { k: "Phase 1 features live", v: "26 / 35" },
      ],
      validation: "“Mission logic over case volume precision.” — Devon Cordell, IME go-live approval, Apr 8, 2026",
    },
    {
      id: "mosaic",
      year: "2025–26",
      title: "Mosaic — AI Support Workspace",
      one: "Replaced 5+ tabs with one AI-assisted troubleshooting surface for ~4,000 support agents.",
      what: "Single-page app embedded in the Marketplace Admin portal. 22 components. Dual lookup (Store ID / Salesforce case). Four issue-specific diagnostic checklists. CHIP AI assistant embedded via Glean. Discovered three telemetry footguns the self-serve docs missed — dual entity registration, missing user-ID propagation, silent SDK failures — and documented the fix as a team reference.",
      stack: ["React 18", "TypeScript", "GraphQL", "Iguazu telemetry SDK"],
      stats: [
        { k: "Components", v: "22" },
    ...
    },
    {
      ...
      what: "Co-designed and co-facilitated the original workshop for 180 senior leaders at the InMotion summit. Built the four-phase framework with concrete examples and a hands-on lab where leaders defined a real challenge and shipped a working AI solution in the room. Recovered live from a mid-demo platform outage by pivoting to audience Q&A — the workshop kept going. Reused at scale: 200–500 leaders at CXI AI Fluency, Spanish-language Gemini Gems in CDMX, Custom Agents at Build Better Week.",
      ...
      validation: "“Directors come to Sam now. The excitement around the tooling — and the level we are at to help people realize the power of it.” — Josiah Clark, post-workshop DM, Apr 24, 2026",
    },
    {
      id: "chip",
      year: "2025–26",
      title: "CHIP — Specialist Support Chatbot",
  ...
  arc: [
    ...
    { year: "2025", phase: "Builder", title: "Technical Integrations Associate", org: "DoorDash · MXO", note: "First production code shipped. Four production apps. Funded business case ($91K). 880+ leaders trained. Two Excellence Awards." },
    { year: "2026", phase: "Architect", title: "AI Ecosystem Architect", org: "DoorDash · MXO AI Studio", note: "Six-agent autonomous fleet. 21 skills auto-distributed to 41 teammates. Public AI-tools intake channel. Tech lead on flagship support chatbot." },
  ],

  // Real names, real quotes, real attributions.
  validation: [
    { quote: "Directors come to Sam now. The excitement around the tooling — and the level we are at to help people realize the power of it.", who: "Josiah Clark", role: "Peer engineer", on: "DM, Apr 24 2026" },
    { quote: "These are amazing!!!!", who: "Chris Sanchez", role: "Senior Manager, MXO Integrations Ops", on: "Repo refresh delivery, Apr 24 2026" },
    { quote: "This is so cool — going to save me.", who: "WFM stakeholder", role: "Operations leadership", on: "Live demo, Feb 20 2026" },
    { quote: "Mission logic over case volume precision.", who: "Devon Cordell", role: "IME stakeholder", on: "Go-live approval, Apr 8 2026" },
    { quote: "Literally the ABCs. So big shout out to you.", who: "Mary", role: "CXI session closer", on: "200–500 attendees, Apr 22 2026" },
    { quote: "Amazing!!! TYSM!", who: "Kathleen Nguyen", role: "New team member", on: "670-line onboarding guide" },
  ],

  awards: [
    { year: "2025", title: "Merchant Services Excellence Award", from: "Senior Director Jennifer Walker Davidson", reason: "AI as a Leadership Tool · InMotion summit workshop" },
  ...
  stack: {
    ...
    Data: ["Snowflake (CTEs · window fns)", "Sigma · Mode", "Bayesian analysis", "A/B design", "ETL"],
    AI: ["Claude API", "Anthropic Agent SDK", "MCP servers", "Glean agents", "Ollama · MLX Whisper", "Kokoro TTS"],
    Platform: ["pnpm monorepo", "BuildKite", "GitHub Actions", "AWS Lambda", "Iguazu telemetry"],
