...
window.PORTFOLIO_DATA_V4 = {
  identity: {
    ...
    pitch: "I came up through ops (call center, EMT dispatch, escalations) and now I ship the React, TypeScript, and Snowflake code that fixes what I used to triage. I own the customer outcome end to end: scope it, ship it, measure it.",
  ...
  // Two role tracks — same person, different lens. (SWE variant retired.)
  tracks: [
    {
      key: "fde",
  ...
  migration: {
    ...
    build: "Designed the operating model end-to-end: CRM-routed queues, 3-day cadence, 200 to 300 touches/day, training docs, escalation paths. Built the migration dashboard: full funnel, migration progress, revenue at every stage, in one view.",
    result: [
      { v: "94%", k: "retention of at-risk revenue" },
      { v: "10", k: "agent vendor pod stood up" },
      { v: "Under", k: "budget delivery" },
      { v: "20+ to few", k: "daily escalations, before to after" },
    ],
  },
  ...
  projects: [
    {
      ...
      what: "Production workforce platform consolidating multiple operational data sources into one operating surface. 18 dashboard pages, micro-frontend architecture, published shared component library. An external operations lead independently validated the data within 0.9% of the legacy system. Sustained weekly release cadence in 2026.",
      stack: ["React 18", "TypeScript", "Zustand", "Snowflake", "Recharts", "Erlang C"],
      stats: [
        { k: "Pages built", v: "18" },
        { k: "Queues unified", v: "100+" },
        { k: "External validation", v: "within 0.9% of legacy" },
        { k: "Release cadence", v: "weekly" },
      ],
    },
    {
      id: "ime",
      ...
      what: "Dual-stack: React frontend, Fastify BFF, Snowflake. Solved the bugs the team would have lost weeks to: a typed callback that silently terminated the warehouse connection, an auth race opening multiple browser tabs, and a silent row cap on the AI query service. Now embedded in the broader workforce platform.",
    ...
    },
    {
      id: "fleet",
      year: "2026",
      title: "6-Agent Local Dev Fleet (personal)",
  ...
  arc: [
    ...
    { year: "2022", phase: "Specialist", title: "Merchant Services Senior Specialist", org: "DoorDash · Tempe", note: "Onboarded 9,000+ stores. SOPs that extended POS provider coverage 1 to 23. Specialist-to-provider ratio 1:1 to 1:7." },
    ...
    { year: "2025", phase: "Builder", title: "Technical Integrations Associate, Engineering & AI", org: "DoorDash · Merchant Ops", note: "First production code shipped. Three production apps. Funded business case authored. 800+ leaders trained across consumer and merchant orgs. Two Excellence Awards." },
    { year: "2026", phase: "Architect", title: "Technical Integrations Associate, Engineering & AI", org: "DoorDash · Merchant Ops", note: "Deepened into AI: built a 6-agent local dev fleet, authored an internal AI builder playbook, and was tech lead on the flagship internal support chatbot (76 MAU)." },
  ],
